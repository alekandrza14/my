...
namespace MyGame { 
    ...
    {
        public const string APP_NAME = "MyGame";
        public const string RELEASE_DATE = "11 Jan 2019";

        public const string FRAGMENT_FILENAME = "MyGame.rayres.shaders.fragment.c";
        public const string VERTEX_FILENAME = "MyGame.rayres.shaders.vertex.c";
        public const string GEOMETRY_FILENAME = "MyGame.rayres.shaders.geometry.c";
